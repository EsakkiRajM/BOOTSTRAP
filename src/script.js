...
let countDownResult = (callback) => {
    setTimeout(() => {
        output.innerHTML = "Love you susi, romba kasta paduthiruntha, Nee than naye yenakku yeppavume special ma, unna vida yenakku yarum inportant illa naye, love you too and unlimited naye, yen kudave iru naye love you naye";
        callback();
    }, 1000);
}
